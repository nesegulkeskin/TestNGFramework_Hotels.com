...
WebDriver driver;
	...
	public static void scrollByElement(WebDriver driver, By locator){
		WebElement scrollElement = ElementUtil.webAction(locator);
		JavascriptExecutor js = ((JavascriptExecutor) driver);
		js.executeScript("arguments[0].scrollIntoView();", scrollElement);
	}
	
	public static void scrollByPixel(WebDriver driver, String xPixel, String yPixel){
